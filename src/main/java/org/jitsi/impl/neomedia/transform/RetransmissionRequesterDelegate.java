...
public class RetransmissionRequesterDelegate
     ...
     * RTP packet.
     */
    public static final int MAX_REQUESTS = 10; // zorro 50
     ...
     */
    public static final int RE_REQUEST_AFTER_MILLIS = 150; // zorro 30
     ...
     */
    public static final long WAKEUP_INTERVAL_MILLIS = 1000; // zorro 200
    ...
    private class Requester {
        ...
        synchronized private boolean received(int seq) {
            ...
            if (diff <= 0) {
                ...
                for (int missing = (lastReceivedSeq + 1) % (1 << 16); missing != seq; missing = (missing + 1)
                        % (1 << 16)) {
